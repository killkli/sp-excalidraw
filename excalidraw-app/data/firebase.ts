...
const credentials = {
  accessKeyId: "rmhWn3nhd5KXkl54",
  secretAccessKey: "9WrIEdIBKxEybArO2mZjgu2Gs2XaMSpOr0BR1a1J"
};
...
export const loadFilesFromFirebase = async (
  ...
  await Promise.all(
    [...new Set(filesIds)].map(async (id) => {
      try {
        const url = `https://s3.tebi.io/excalidraw/${encodeURIComponent(prefix.replace(/^\//, ""))}%2F${id}`;
